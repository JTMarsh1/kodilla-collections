...
public class Stamp {
    ...
    public Stamp(String stampName, double stampSize, boolean stampedStamp) {
    ...
    public boolean equals(Object o) {
        ...
        Stamp stamp = (Stamp) o;
        return Double.compare(stamp.stampSize, stampSize) == 0 && stampedStamp == stamp.stampedStamp && Objects.equals(stampName, stamp.stampName);
    }
